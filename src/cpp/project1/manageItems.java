...
public class manageItems extends javax.swing.JInternalFrame {
    ...
    public void SelectItem(){
        try{
            ...
            Rs=St.executeQuery("Select * from malasha.MANAGEITEMTTB");
...
private void theader()
        ...
        if(ItemCode.getText().isEmpty()||ItemName.getText().isEmpty()||SellingPrice.getText().isEmpty()||ItemQuantity.getText().isEmpty()||ItemDescription.getText().isEmpty()||"  Enter Item Code".equals(ItemCode.getText())||"  Enter Item Name".equals(ItemName.getText())||"  Enter Selling Price".equals(SellingPrice.getText())||"  Enter Quantity".equals(ItemQuantity.getText())||"  Enter Description".equals(ItemDescription.getText()))
    {
        ...
        try {
                Con=DriverManager.getConnection("jdbc:derby://localhost:1527/db","malasha","malasha@01");
            String Query ="Update malasha.MANAGEITEMTTB set ITEM_NAME='"+ItemName.getText()+"'"+",ITEM_CATEGORY='"+ItemCategory.getSelectedItem().toString()+"'"+",SELLING_PRICE="+SellingPrice.getText()+",QUANTITY="+ItemQuantity.getText()+",DESCRIPTION='"+ItemDescription.getText()+"'"+",RECOMMENDATION='"+ItemRec.getText()+"'"+"where ITEM_CODE='"+ItemCode.getText()+"'";
            String Query2="Update malasha.MANAGEITEMTTB set ITEM_NAME='"+ItemName.getText()+"'"+",ITEM_CATEGORY='"+ItemCategory.getSelectedItem().toString()+"'"+",SELLING_PRICE="+SellingPrice.getText()+",QUANTITY="+ItemQuantity.getText()+",DESCRIPTION='"+ItemDescription.getText()+"'"+",RECOMMENDATION='"+" "+"'"+"where ITEM_CODE='"+ItemCode.getText()+"'";
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        if(ItemCode.getText().isEmpty()||"  Enter Item Code".equals(ItemCode.getText()))
      {
          ...
          try{
               ...
               String Query="Delete from malasha.MANAGEITEMTTB where ITEM_CODE='"+ICD+"'";
               Statement Add=Con.createStatement();
               Add.executeUpdate(Query);
               SelectItem();
