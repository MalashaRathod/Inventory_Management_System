...
public class Employee_ForgetPassword extends javax.swing.JFrame {
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        try{
            ...
            Rs=St.executeQuery("Select * from malasha.MANAGEEMPLOYEETB where LOGIN_ID="+Username.getText()+"and ANSWER='"+Answer.getText()+"'");
            if(Rs.next()){
                St.executeUpdate("Update malasha.MANAGEEMPLOYEETB set PASSWORD='"+NewPass.getText()+"'" +"where LOGIN_ID="+Username.getText());
